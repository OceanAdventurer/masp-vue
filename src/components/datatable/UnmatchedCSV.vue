  ...
  <el-form :inline="true" :model="form" class="demo-form-inline">
    <div class="pos-a w100 h100 df df-fd-c">
      <div class="mt10 mb10"  style="padding:0px 10px">
          <el-form-item label="源文件名:" style="margin-bottom: 0px">
            <el-input style="width:150px" v-model="form.fileName" clearable placeholder="请输入内容"></el-input>
          </el-form-item>
          <el-form-item label="起飞时间:" style="margin-bottom: 0px">
            <div class="block">
            <el-date-picker
              style="width:300px"
          ...
          <el-form-item label="航班号:" style="margin-bottom: 0px">
            <el-select v-model="form.flightNo" remote  :remote-method="remoteMethod"
                       :loading="loading" clearable  filterable placeholder="" style="width:100px">
              <el-option
...
export default {
  ...
  methods: {
    ...
    flightExport () {
      ...
      let params = {
        hasETL: this.form.HASETL,
        hasCSV: this.form.HASCSV,
        dateStart: this.form.flightDate ? this.form.flightDate[0] : '',
        dateEnd: this.form.flightDate ? this.form.flightDate[1] : '',
      ...
      this.$axios({
        url: '/etl/unCompletionFileDownload',
        method: 'post',
    ...
    readCompletionInfo (pageNo) {
       ...
       let params = {
        ...
        this.$axios({
          url: '/etl/unCompletionFileDetail',
          method: 'post',
          data: JSON.stringify(params),
          headers: {
           'Content-type': 'application/json;charset=UTF-8'
