            ...
            <el-tab-pane label="筛选配置" name="filterConfig">
              <div class="filter-config-table">
                <el-table
                  ...
                  <el-table-column prop="name" label="参数" width="300"></el-table-column>
            ...
            <el-tab-pane label="属性" name="attr">
              ...
              <div v-show="fileNewContentActiveName === 'filterConfig'">
                ...
                <div class="m20 df df-fd-c df-jc-fs df-ai-fs" v-show="currentFilterConfigRowAttr === 6">
                  ...
                  <div class="df df-fd-c df-jc-fs df-ai-fs w100 data-point dynamic_time" v-show="attrSixRadio === '11'">
                    <el-row>
                      ...
                      <el-input-number type="nummber" v-model="dynamicTime" @change="getDynamicDateRange"></el-input-number>
                      {{dynamicType === 'day' ? '天' : dynamicType === 'week' ? '周' : dynamicType === 'month' ? '月' : dynamicType === 'quarter' ? '季度' : '年'}}
                    </el-row>
                  </div>
                </div>
                <!-- 筛选配置属性中第七种类型 非搜索类型-->
...
export default {
  ...
  data () {
    return { // 以下是此组件的默认值
      ...
      dynamicTime: 0, // 筛选配置第六类属性中按动态范围日期
      dynamicType: 'day',
      typeRange: [
        {value: 'year', label: '当年'},
  ...
  methods: {
    ...
    resetAttrSixDefaultData (flag) { // 重置筛选配置第六类属性的值
      ...
      this.dynamicTime = 0 // 筛选配置第六类属性中动态范围
      this.dataPointY = []
      this.dataPointM = []
      this.dataPointD = []
      this.dataPointH = []
...
.data-point .type_class .el-input.el-input--suffix {
  width: 90px;
}
</style>
<style scoped>
